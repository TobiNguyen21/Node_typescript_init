...
export default class ItemRouter {
    ...
    public routes(): void {
        ...
        this.router.post('/', validator, asyncHandle(item_Controller.post));
        this.router.put('/:id', validator, asyncHandle(item_Controller.put));
        this.router.delete('/:id', asyncHandle(item_Controller.delete));
    }
}