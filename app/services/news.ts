...
export default class Main_service {
    static async listItems(params: any, option: any = {}): Promise<any> {
        ...
        if (params.req.cookies.expiration_time_rss && Date.now() <= params.req.cookies.expiration_time_rss) {
            ...
            try {
                ...
                params.res.cookie('expiration_time_rss', Date.now() + expiresIn_rss * 60 * 1000);
